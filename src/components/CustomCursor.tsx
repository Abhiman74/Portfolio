    ...
    <>
      ...
      <motion.div
        ...
        animate={{
          ...
          borderColor: hovered ? "rgba(99, 102, 241, 0.5)" : "rgba(99, 102, 241, 0.25)",
        }}
        transition={{ type: "tween", ease: "backOut", duration: 0.2 }}
        className="fixed top-0 left-0 w-8 h-8 rounded-full border border-indigo-500 pointer-events-none z-[999999] hidden md:block"
      />
      {/* Inner dot */}
      <motion.div
        style={{
        ...
        className="fixed top-0 left-0 w-3 h-3 rounded-full bg-indigo-500 pointer-events-none z-[999999] translate-x-[10px] translate-y-[10px] hidden md:block"
      />
    </>
  );
}
